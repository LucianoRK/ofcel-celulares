...
<div class="card">
    <div class="card-body">
        <ul class="nav nav-tabs" id="ativosTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="inativos-tab" data-toggle="tab" href="#inativos" role="tab" aria-controls="inativos" aria-selected="false">Inativos <span class="badge badge-count"><?= count($marcasInativo) ?></span></a>
            </li>
        </ul>
        <div class="tab-content mt-3">
            ...
            <div class="tab-pane fade" id="inativos" role="tabpanel" aria-labelledby="inativos-tab">
                <table class="table table-striped dataTable">
                    ...
                    <tbody>
                        <?php if ($marcasInativo) : ?>
                            <?php foreach ($marcasInativo as $marca) : ?>
                                <tr class="linhaTabela">
                                    <td><?= $marca['marca_id'] ?></td>
                                    <td><?= $marca['nome'] ?></td>
                                    <td class="text-right">
