! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() {
    ...
    function z(t, e, n) {
        var o, i;
        if (i = e, h((o = t).classList).forEach(function(t) {-1 === m(J).indexOf(t) && -1 === m(X).indexOf(t) && -1 === m(i.showClass).indexOf(t) && o.classList.remove(t) }), e.customClass && e.customClass[n]) {
    ...
    var gt, vt = function(t, e) { ot(t, e, !0) },
        ...
        kt = function(t) {
            var e, n, o, i, r, a, s, c, u, l, d, p, f, m, h, g = !!(e = C()) && (e.parentNode.removeChild(e), yt([document.documentElement, document.body], [J["no-backdrop"], J["toast-shown"], J["has-column"]]), !0);
    ...
    var Ot = { promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap },
        ...
        It = {};
    It.text = It.email = It.password = It.number = It.tel = It.url = function(t, e) { return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : b(e.inputValue) || K('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), Et(t, e), t.type = e.input, t }, It.file = function(t, e) { return Et(t, e), t }, It.range = function(t, e) {
        var n = t.querySelector("input"),
            o = t.querySelector("output");
        return n.value = e.inputValue, n.type = e.input, o.value = e.inputValue, t
    }, It.select = function(t, e) { var n; return t.textContent = "", e.inputPlaceholder && (n = document.createElement("option"), _(n, e.inputPlaceholder), n.value = "", n.disabled = !0, n.selected = !0, t.appendChild(n)), t }, It.radio = function(t) { return t.textContent = "", t }, It.checkbox = function(t, e) {
        var n = et(A(), "checkbox");
    ...
    var _t = function() { for (var t = n(), e = 0; e < t.length; e++) at(t[e]) },
    ...
    function ne(t) { for (var e in t) te(i = e) || K('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== se.indexOf(o) && K('The parameter "'.concat(o, '" is incompatible with toasts'))), ee(n = e) && g(n, ee(n)); var n, o, i }
    var oe = {},
        ...
        ce = Object.freeze({
            ...
            argsToParams: function(o) { var i = {}; return "object" !== r(o[0]) || w(o[0]) ? ["title", "html", "icon"].forEach(function(t, e) { var n = o[e]; "string" == typeof n || w(n) ? i[t] = n : void 0 !== n && Y("Unexpected type of ".concat(t, '! Expected "string" or "Element", got ').concat(r(n))) }) : c(i, o[0]), i },
            ...
            getTitle: P,
            getContent: A,
            getHtmlContainer: function() { return e(J["html-container"]) },
            getImage: S,
            getIcon: B,
            getIcons: n,
            getCloseButton: R,
            ...
            increaseTimer: function(t) { if (oe.timeout) { var e = oe.timeout.increase(t); return dt(e, !0), e } },
    ...
    function ye(t) {
        ...
        i && (t = function(t) { return void 0 !== t ? c({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, t) : { isConfirmed: !1, isDenied: !1, isDismissed: !0 } }(t), (e = Ot.innerParams.get(this)) && !F(i, e.hideClass.popup) && (n = ge.swalPromiseResolve.get(this), yt(i, e.showClass.popup), vt(i, e.hideClass.popup), o = C(), yt(o, e.showClass.backdrop), vt(o, e.hideClass.backdrop), function(t, e, n) {
            var o = C(),
                ...
                s = n.willClose,
                c = n.didClose;
            if (be(e, s, r), i) { we(t, e, o, c || a) } else { ve(t, o, G(), c || a) }
        }(this, i, e), n(t)))
    }
    ...
    function Me(t, e, n) { Ot.innerParams.get(t).toast ? an(t, e, n) : (cn(e), un(e), ln(t, e, n)) }
    var Ve = function(t, e) { "function" == typeof e.didOpen ? setTimeout(function() { return e.didOpen(t) }) : "function" == typeof e.onOpen && setTimeout(function() { return e.onOpen(t) }) },
        ...
        ze = function(e, n) {
            function o(t) { return Ke[n.input](i, Ye(t), n) }
            var i = A();
    ...
    var dn = function(t, e, n) {
        ...
        mn = function() { document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur() };
    var hn, gn = function(t) { for (var e in t) t[e] = new WeakMap },
        vn = Object.freeze({
            hideLoading: ue,
            disableLoading: ue,
            getInput: function(t) {
            ...
            closeModal: ye,
            closeToast: ye,
            enableButtons: function() { ke(this, ["confirmButton", "denyButton", "cancelButton"], !1) },
            disableButtons: function() { ke(this, ["confirmButton", "denyButton", "cancelButton"], !0) },
            enableInput: function() { return xe(this.getInput(), !1) },
            disableInput: function() { return xe(this.getInput(), !0) },
            ...
            getProgressSteps: function() { return Ot.domCache.get(this).progressSteps },
            _main: function(t) {
                ...
                var n = function(t) { var e = { popup: x(), container: C(), content: A(), actions: j(), confirmButton: T(), denyButton: L(), cancelButton: q(), loader: D(), closeButton: R(), validationMessage: O(), progressSteps: E() }; return Ot.domCache.set(t, e), e }(this);
                return Nt(this, e), Ot.innerParams.set(this, e),
                    function(n, o, i) {
                        return new Promise(function(t) {
                            ...
                            Me(n, o, e);
                            je(n, oe, i, e);
                            if (i.toast && (i.input || i.footer || i.showCloseButton)) { vt(document.body, J["toast-column"]) } else { yt(document.body, J["toast-column"]) }
                            Oe(n, i);
                            Se(i);
                            dn(oe, i, e);
                            pn(o, i);
            ...
            update: function(e) {
                ...
                var i = c({}, n, o);
                Nt(this, i), Ot.innerParams.set(this, i), Object.defineProperties(this, { params: { value: c({}, this.params, e), writable: !1, enumerable: !0 } })
            },
            _destroy: function() {
                var t = Ot.domCache.get(this),
        ...
        yn = function() {
            ...
            return s(r, [{ key: "then", value: function(t) { return Ot.promise.get(this).then(t) } }, { key: "finally", value: function(t) { return Ot.promise.get(this).finally(t) } }]), r
        }();
    c(yn.prototype, vn), c(yn, ce), Object.keys(vn).forEach(function(t) { yn[t] = function() { if (hn) return hn[t].apply(hn, arguments) } }), yn.DismissReason = $, yn.version = "10.3.5";
    var bn = yn;
